...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: NgxScrollPositionRestorationService, decorators: [{
        ...
        return [{ type: i1.Router }, { type: i0.NgZone }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: CustomRouterOutletDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i1.Router }, { type: i1.RouterOutlet }, { type: NgxScrollPositionRestorationService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
                    }] }, { type: undefined, decorators: [{
                        type: Inject,
